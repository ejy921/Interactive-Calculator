...
import java.util.Scanner;
  ...
  * @author: Jinny Eo
  * 
  * Continuously receives user input of expressions and prints out answer each time. 
  * User has choice to store a variable to a character. Quits when the user inputs "QUIT". 
  * Checks for invalid commands, such as when the user attempts to save or retrieve an 
  * invalid variable, as well as invalid expressions (through use of BFCalculator).
  */
